...
noisy_score= (vizual.test_clusters(noisydf[considered_feat]))
...
for (prof,score) in benefit_ordering:
	...
	new_score=vizual.test_clusters(new_df[considered_feat])#Adult.train_classifier(new_df,considered_feat,'sex')
